...
class Main(QMainWindow, Ui_MainWindow, QWidget):
    def __init__(self):
        ...
        loadUi(r"C:\Users\Vinicius\Documents\GitHub\TCC\03_MVC\teste\teste_V6.ui", self)
        self.reg_historico()
    ...
    def att_historico(self):
        ...
        histlib = {"DemMedida_fp": demMed_fp, "DemMedida_p": demMed_p, "ConsumoFP": consFP, 
    ...
    def faturaDemanda(self, demCont_fp=0.0, demCont_p=0.0):
        ...
        [demMed_fp, demMed_p, consFP, consP, demContratada_fp, demContratada_p, modtar] = historico
    ...
    def faturaOtima(self):
        ...
        demMed_fp, demMed_p, consFP, consP, demContratada_fp, demContratada_p, modtar = self.att_historico()
